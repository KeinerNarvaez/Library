...
public class editorialController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<responseDTO> updateEditorial(@PathVariable int id,@RequestBody editorialDTO editorialDTO) {
        responseDTO respuesta = editorialService.update(id, editorialDTO);
        return new ResponseEntity<>(respuesta, respuesta.getStatus());
    }
}