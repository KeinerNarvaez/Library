...
public class bill_loanService {
    ...
    public responseDTO save(bill_loanDTO bill_loanDTO) {
        ...
        bill_loan savedLoan = billLoanRepository.save(billRecord);
        bill_loanDTO responseLoan = convertToDTO(savedLoan);
    ...
    public bill_loanDTO convertToDTO(bill_loan bill_loan) {
        return new bill_loanDTO(
            ...
            bill_loan.get_code(),
            bill_loan.get_date(),
            bill_loan.get_id_user().getId_user(),
            bill_loan.get_name_customer()
        );
    }
    ...
    public bill_loan convertToModel(bill_loanDTO bill_loanDTO, user userRol) {
        return new bill_loan(
            ...
            LocalDateTime.now(),
            userRol,
            bill_loanDTO.get_name_customer()
        );
    }
}
